...
warm-sunset`)
    ...
    let images = `https://violetics.pw/api/photofilter/${encodeURIComponent(text)}?apikey=${global.viokey}&image=${encodeURIComponent(url)}`
    await conn.sendFile(m.chat, images, '', `🔗 Url : ${url}`, m)
            }
